      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <router-link to="/HomeView" class="nav-link" @click="toggleLogin" style="color: #ffffff;">首頁</router-link>
            </li>
                                ...
                                <div v-if="item.SkillUpgradeRecord.getFireBall" class="skills-container">
                                  ...
                                  <div class="column">
                                    <div
                                      ...
                                      style="text-align: left;"><a>沒有強化過此類魔法</a></div>
                                  ...
                                  <div class="column">
                                    ...
                                    <div v-else style="text-align: left;"><a
                                        ...
                                        v-if="item.SkillUpgradeRecord.LightningBlastHitRange">連鎖距離提升：{{
                                          (item.SkillUpgradeRecord.LightningBlastHitRange * 0.2).toFixed(1) }}<br /></a><a
                                        v-if="item.SkillUpgradeRecord.LightningBlastAttackRange">鎖敵距離提升：{{
                                          (item.SkillUpgradeRecord.LightningBlastAttackRange * 0.1).toFixed(1) }}<br /></a>
                                    </div>
                                  </div>
                                </div>
